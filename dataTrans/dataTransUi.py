...
#
# Created: Wed Jun 18 19:37:03 2014
...
class Ui_dataTransWidget(object):
    def setupUi(self, dataTransWidget):
        ...
        dataTransWidget.resize(557, 499)
        ...
        self.pbtnFileFormat = QtGui.QPushButton(self.groupBox_2)
        self.pbtnFileFormat.setObjectName(_fromUtf8("pbtnFileFormat"))
        self.horizontalLayout_4.addWidget(self.pbtnFileFormat)
    ...
    def retranslateUi(self, dataTransWidget):
        ...
        self.pbtnFileFormat.setText(_translate("dataTransWidget", "数据文件格式设定", None))
